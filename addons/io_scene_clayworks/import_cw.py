...
"""
This script imports a Clayworks scene to Blender.

Usage:
Run this script from "File->Import" menu and then load the desired v3d scene file.
...
def v3d_image_load(imagepath, DIR, recursive):
    '''
...
def create_materials(filepath, material_libs, unique_materials, unique_material_images, use_image_search):
    '''
    Create all the used materials in this v3d,
    ...
    def load_material_image(blender_material, context_material_name, imagepath, type):
        ...
        image = v3d_image_load(imagepath, DIR, use_image_search)
        has_data = False
    ...
    # Add an MTL with the same name as the v3d if no MTLs are spesified.
            ...
            for line in mtl:  # .readlines():
                ...
                if not line or line.startswith(b'#'):
                    ...
                    if line_lower.startswith(b'ka'):
                        ...
                        """
                        # XXX, this is not following the v3d spec, but this was
...
def get_float_func(filepath):
    '''
    find the float function for this v3d file
...
def load_mesh(operator, context, filepath,
         global_clamp_size=0.0,
         use_ngons=True,
         use_smooth_groups=True,
         use_edges=True,
